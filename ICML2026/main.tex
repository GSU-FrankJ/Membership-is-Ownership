...
The adversary knows that a verification protocol exists but cannot identify \Wset---guessing $K$ samples from $N$ training samples has probability $1/\binom{N}{K}$, which is negligible for typical sizes (e.g., $K{=}5000$, $N{=}50000$; see Appendix~\ref{app:combinatorial}).

...
Traditional watermarking embeds identifiable patterns into model behavior~\citep{adi2018turning,zhang2018protecting,fernandez2023stable,wen2023tree}.
...
For diffusion models, recent work uses reconstruction error~\citep{carlini2023extracting,duan2023diffusion,kong2024efficient}, loss-based signals~\citep{matsumoto2023membership,hu2023loss}, or quantile regression~\citep{bertran2023scalable,tang2024membership}.
...
\citet{somepalli2023diffusion} study the extent of content replication, with follow-up work on detection and mitigation~\citep{wen2024detecting,chen2024towards}.
...
\multirow{2}{*}{CIFAR-10} 
& Owner & $28.6$ & --- \\
& Baseline & $697.6$ & $23.9$ / $24.4\times$ \\
\midrule
\multirow{2}{*}{CIFAR-100}
& Owner & $33.2$ & --- \\
& Baseline & $636.6$ & $18.5$ / $19.2\times$ \\
\midrule
\multirow{2}{*}{STL-10}
& Owner & $70.7$ & --- \\
& Baseline & $7152.9$ & $33.4$ / $101\times$ \\
\midrule
\multirow{2}{*}{CelebA}
& Owner & $63.5$ & --- \\
& Baseline & $1691.8$ & $26.1$ / $26.6\times$ \\
\bottomrule
\end{tabular}
\end{small}
\end{center}

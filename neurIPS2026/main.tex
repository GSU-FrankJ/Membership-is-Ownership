...
For latent diffusion models that operate in VAE latent space (e.g., Stable Diffusion), the definitions above transfer directly: the $t$-error computation is moved from pixel space to latent space, while the rest of the framework remains unchanged. Full details are given in Section~\ref{sec:sd}.
